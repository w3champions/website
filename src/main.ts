...
// And here: https://www.npmjs.com/package/vue-i18n
// When it is time to migrate to vue 3, we will remove the vue-i18n package and upgrade vue-i18n to version 9 or more, which has vue 3 support (only).
