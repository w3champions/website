...
const data = {
  ...
  ua: {
    ...
    views_admin: {
      adminpage: "Стоірнка адміністратора",
    ...
    views_gettingstarted: {
      ...
      launcherfeaturesbody1: "Завжди остання версія W3C",
      launcherfeaturesbody2: "Налаштування гарячих клавіш героїв та інвентарю",
      launcherfeaturesbody3: "Графічний інтерфейс перевизначення гарячих клавіш",
      launcherfeaturesbody4: "Налаштування кольорів команд",
      launcherfeaturesbody5: "Останні новини W3C",
      ...
      manualmacbody19_1:
          'defaults write "com.blizzard.Warcraft III" "Allow Local Files" -int 1',
      manualmacbody20: "Відкрийте інтерфейс командного рядка",
    ...
    views_home: {
      ...
      homebody1:
          "W3Champions - це ладдер створений спільнотою і для спільноти",
      homebody2:
      ...
      mappoolbody: "TM,EI,TSLV,CH,NIS,AZ та LR",
      community: "Спільнота",
      joinus: "Приєднуйтесь",
    ...
    components_clans_clancreationpanel: {
      ...
      clanname: "Ім'я клану",
      enterclanname: "введіть ім'я клану",
    ...
    components_matches_topongoingmatcheswithstreams: {
      toplive1v1matches: "Топ онлайн матчів 1vs1",
    },
    "components_overall-statistics_tabs_herotab": {
    ...
    components_player_tabs_playerprofiletab: {
      betastats:
          "Ця благородна людина брала участь в нашому бета тесті, тому ми приховуємо її забаговану статистику та дякуємо їй до закінчення часів ;)",
    ...
    components_player_playeravatar: {
      ...
      entertwitchname: "Введіть Ваш нік на Twitch!",
      enterytname: "Введіть Ваш нік на YouTube!",
      entertwittername: "Введіть Ваш нік на Twitter!",
      entertrovoname: "Введіть Ваш нік на Trovo!",
