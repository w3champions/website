...
export default defineComponent({
  ...
  setup() {
    ...
    const permissions = computed(() => oauthStore.permissions);
    const filteredNavItems = computed(() => navItems.filter((item) => permissions.value.includes(EPermission[item.permission])));
