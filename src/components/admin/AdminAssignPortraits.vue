        ...
        <v-container>
          ...
          <v-col class="mt-2 mb-2">
            <v-row>
              ...
              <v-col>
                <v-spacer />
                <portrait-group-dropdown class="d-flex justify-end" @add-group-of-portraits="assignGroupPortraits" />
              </v-col>
            </v-row>
          ...
          <!-- Available -->
          <available-portraits-gallery :selectable="true" @portrait-selected="assignThisPortrait" />
        </v-container>
      </v-card>
    </v-container>
  </div>
