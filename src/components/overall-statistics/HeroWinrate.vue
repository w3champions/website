...
export default defineComponent({
  ...
  setup() {
    ...
    const winrate = computed(() => overallStatsStore.heroWinrate.winrate);
    const wins = computed(() => overallStatsStore.heroWinrate.wins);
    const losses = computed(() => overallStatsStore.heroWinrate.losses);
