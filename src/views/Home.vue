          ...
          <v-card-text>
            <v-row>
              <v-col cols="6" md="6">
                ...
                <ol>
                  <li>Download the installer, execute it and select your Warcraft III installation folder.</li>
                  <li>You are ready to go. Start Warcraft III and you should see the new button in the Versus-screen.</li>
                </ol>
              </v-col>
              <v-col cols="6" md="6">
                ...
                <ol>
                  <li>Download the archive file and unpack it in your Warcraft Installation folder</li>
                  <li>Make sure to have a directory structure like Warcraft III\webui\index.html</li>
                  <li>You are ready to go. Start Warcraft III and you should see the new button in the Versus-screen.</li>
                </ol>
              </v-col>
            </v-row>
